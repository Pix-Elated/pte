    ...
    egui::Window::new("Preferences")
        ...
        .show(ctx, |ui| {
            ...
            egui::Grid::new("prefs_general_grid")
                ...
                .show(ui, |ui| {
                    ui.label(
                        egui::RichText::new("Undo Limit:")
                            .size(11.0)
                            .color(theme::TEXT_SECONDARY),
                    );
                    let mut limit = state.undo_limit as i32;
                    if ui
                        .add(egui::DragValue::new(&mut limit).range(10..=1000).speed(1))
                        .changed()
                    {
                    ...
                    ui.label(
                        egui::RichText::new("Interval (sec):")
                            .size(11.0)
                            .color(theme::TEXT_SECONDARY),
                    );
            ...
            egui::Grid::new("prefs_view_grid")
                ...
                .show(ui, |ui| {
                    ...
                    ui.label(
                        egui::RichText::new("Ghost floors:")
                            .size(11.0)
                            .color(theme::TEXT_SECONDARY),
                    );
                    ...
                    ui.label(
                        egui::RichText::new("Show tooltips:")
                            .size(11.0)
                            .color(theme::TEXT_SECONDARY),
                    );
                    ...
                    ui.label(
                        egui::RichText::new("Light overlay:")
                            .size(11.0)
                            .color(theme::TEXT_SECONDARY),
                    );
